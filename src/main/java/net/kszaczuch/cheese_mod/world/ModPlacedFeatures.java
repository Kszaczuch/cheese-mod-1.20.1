package net.kszaczuch.cheese_mod.world;
    ...
    public static void bootstrap(Registerable<PlacedFeature> context) {
        ...
        register(context, SALT_ORE_PLACED_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(ModConfiguredFeatures.SALT_ORE_KEY),
                ModOrePlacement.modifiersWithCount(10,
                        HeightRangePlacementModifier.trapezoid(YOffset.fixed(80), YOffset.fixed(320))));
    }

    public static RegistryKey<PlacedFeature> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, new Identifier(CheeseMod.MOD_ID, name));
    }
